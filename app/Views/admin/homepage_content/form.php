...
<div class="app-content"><div class="container-fluid"><form action="<?= base_url('admin/homepage-content/save'); ?>" method="post" enctype="multipart/form-data"><?= csrf_field(); ?><input type="hidden" name="id" value="<?= $v('id'); ?>"><input type="hidden" name="section_key" value="<?= esc($sectionKey); ?>"><input type="hidden" name="return_to" value="<?= esc($backUrl ?? base_url('admin/homepage-content/' . $sectionKey)); ?>">
